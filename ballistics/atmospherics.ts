/**
 * @author https://github.com/PaulGilchrist/pg-atmospherics
 */
...
const atmospherics = {
    ...
    interpolateArray: (array: number[], arrayIndex: number) => {
    ...
    relativeHumidityAdjustmentFactor: (temperature: number, barometricPressure: number, relativeHumidity: number) => {
